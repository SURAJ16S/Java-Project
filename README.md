...
A modern, full-featured Java desktop application for managing employee work hours, job applications, attendance, and salary calculations.
Designed for organizations to streamline HR processes, from job application approval to work assignment and payroll, with a beautiful, user-friendly interface powered by FlatLaf.
...
Overview
Employee Works Hour & Salary Tracker is a robust Java Swing application for HR and payroll management.
It allows admins to manage job applications, approve candidates, assign work, track attendance, and calculate salaries.
Employees can log in, view their assignments, and track their attendance and salary.
The application uses a MySQL database for persistent storage and features a modern, responsive UI.
...
Database Schema
The application uses a MySQL database named EmployeeDB.
Key tables include:
